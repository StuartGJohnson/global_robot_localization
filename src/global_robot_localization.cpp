  ...
  tf_listener_(tf_buffer_, this, true)
{
  ...
  declare_parameter("coarse_xy_step", 0.5);
  declare_parameter("coarse_yaw_step_deg", 15.0);
  declare_parameter("top_k", 10);
  declare_parameter("candidate_min_xy_separation", 0.0);
  declare_parameter("candidate_min_yaw_separation_deg", 0.0);
  declare_parameter("refine_levels", 3);
  declare_parameter("refine_xy_step", 0.2);
  declare_parameter("refine_yaw_step_deg", 5.0);
  declare_parameter("scan_stride", 1);
  declare_parameter("max_range", 0.0);
  declare_parameter("off_map_distance", 5.0);
  ...
  declare_parameter("free_space_sample_step", 0.15);
  declare_parameter("min_endpoint_count", 20);
